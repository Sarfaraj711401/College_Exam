...
export default function ProfessorPage() {
  ...
  const fetchProfessors = async () => {
    const res = await axios.get("http://localhost:5000/professors");
  ...
  const handleSubmit = async () => {
    try {
      if (editId) {
        await axios.put(
          `http://localhost:5000/update-professor/${editId}`,
          formData
        );
        ...
        await axios.post(
          "http://localhost:5000/add-professor",
          formData
        );
  ...
  const handleDelete = async (id) => {
    ...
    await axios.delete(
      `http://localhost:5000/delete-professor/${id}`
    );
          ...
          <form>
            <div style={styles.section}>
              ...
              <div style={styles.grid}>
                ...
                <input type="file" onChange={handlePhotoUpload} style={styles.input} />
              </div>
            </div>
          ...
          <div style={styles.previewModal}>
            ...
            <div style={styles.previewDetails}>
              ...
              <div style={styles.previewRow}>
                ...
                <span style={styles.value}>{formData.designation}</span>
              </div>

              <div style={styles.previewRow}>
                <span style={styles.label}>Subject</span>
                <span style={styles.value}>{formData.subject}</span>
              </div>
              ...
              <div style={styles.previewRow}>
                ...
                <span style={styles.value}>{formData.experience}</span>
              </div>

              <div style={styles.previewRow}>
                <span style={styles.label}>Bank Name</span>
                <span style={styles.value}>{formData.bank_name}</span>
              </div>

              <div style={styles.previewRow}>
                <span style={styles.label}>Branch Name</span>
                <span style={styles.value}>{formData.branch_name}</span>
              </div>

              <div style={styles.previewRow}>
                <span style={styles.label}>IFSC Code</span>
                <span style={styles.value}>{formData.ifsc_code}</span>
              </div>

              <div style={styles.previewRow}>
                <span style={styles.label}>Account Number</span>
                <span style={styles.value}>{formData.account_number}</span>
              </div>
